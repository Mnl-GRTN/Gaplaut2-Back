...
public class DataBaseInit {
    ...
    @PostConstruct
    public void init() {
        Centre centre1 = new Centre(1, "CHU NANCY", "NANCY", "1 rue de la santé", "54000");
        Centre centre2 = new Centre(2, "CHU STRASBOURG", "STRASBOURG", "2 rue de la santé", "67000");

        if (centreRepository.count() == 0) {
            Centre centre3 = new Centre(3, "CHU METZ", "METZ", "3 rue de la santé", "57000");
        ...
        if (doctorRepository.count() == 0) {
            ...
            Doctor admin = new Doctor(2, "admin", "admin", centre1, "admin", "admin", Collections.singleton(role2));
            admin.setPassword(passwordEncoder.encode(admin.getPassword()));
            doctorRepository.save(admin);

            Doctor admin2 = new Doctor(3, "admin2", "admin2", centre2, "admin2", "admin2",
            ...
            Doctor doctor = new Doctor(4, "doctor", "doctor", centre1, "doctor", "doctor",
                Collections.singleton(role3));
            doctor.setPassword(passwordEncoder.encode(doctor.getPassword()));
            doctorRepository.save(doctor);

            Doctor doctor2 = new Doctor(5, "doctor2", "doctor2", centre2, "doctor2", "doctor2",
                Collections.singleton(role3));
